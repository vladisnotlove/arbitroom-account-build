...
function getBoundingClientRect(element, includeScale) {
  ...
  if ((0,_instanceOf_js__WEBPACK_IMPORTED_MODULE_0__/* .isHTMLElement */ .Re)(element) && includeScale) {
    var offsetHeight = element.offsetHeight;
    var offsetWidth = element.offsetWidth; // Do not attempt to divide by 0, otherwise we get `Infinity` as scale
    // Fallback to 1 in case both values are `0`

    if (offsetWidth > 0) {
      scaleX = (0,_utils_math_js__WEBPACK_IMPORTED_MODULE_1__/* .round */ .NM)(rect.width) / offsetWidth || 1;
    }

    if (offsetHeight > 0) {
      scaleY = (0,_utils_math_js__WEBPACK_IMPORTED_MODULE_1__/* .round */ .NM)(rect.height) / offsetHeight || 1;
    }
  }
...
var createPopper = __webpack_require__(8240);
...
/* harmony import */ var _createPopper_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8240);
...
function getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === enums/* viewport */.Pj ? rectToClientRect(getViewportRect(element)) : (0,instanceOf/* isElement */.kK)(clippingParent) ? getInnerBoundingClientRect(clippingParent) : rectToClientRect(getDocumentRect((0,getDocumentElement/* default */.Z)(element)));
...
var constants_1 = __webpack_require__(8969);
...
var core_1 = __webpack_require__(9704);
...
var setValue = function (input, value) {
    input === null || input === void 0 ? void 0 : input.setAttribute("value", value);
    input === null || input === void 0 ? void 0 : input.dispatchEvent(new Event("change"));
};
var updateActive = function (toggleButtonGroup, value) {
    toggleButtonGroup.querySelectorAll(".toggle-button").forEach(function (button) {
...
var addToggleButtonGroup = function () {
    var groups = document.querySelectorAll(".toggle-button-group");
    groups.forEach(function (toggleButtonGroup) {
        ...
        if (input) {
            input.addEventListener("change", function () {
                var value = input.value;
                updateActive(toggleButtonGroup, value);
            });
            updateActive(toggleButtonGroup, input.value);
        }
    });
};
exports.Z = addToggleButtonGroup;
...
__webpack_unused_export__ = true;
var core_1 = __webpack_require__(9704);
var addOnAttrChange_1 = __webpack_require__(9418);
var popperModifiers_1 = __webpack_require__(1607);
var variables_module_scss_1 = __webpack_require__(4908);
var popperEnable_1 = __webpack_require__(444);
...
__webpack_unused_export__ = true;
var cssVariables_1 = __webpack_require__(1503);
...
__webpack_unused_export__ = true;
var showTooltip_1 = __webpack_require__(232);
...
exports.Z = addBuyEventTicketModals;
...
exports.__esModule = true;
var isTouchEnabled_1 = __webpack_require__(145);
...
__webpack_unused_export__ = true;
var swiper_1 = __webpack_require__(6541);
...
// EXTERNAL MODULE: ./node_modules/@popperjs/core/lib/popper.js
var lib_popper = __webpack_require__(804);
// EXTERNAL MODULE: ./src/js/utils/popperModifiers.ts
var popperModifiers = __webpack_require__(1607);
// EXTERNAL MODULE: ./src/js/utils/popperEnable.ts
var popperEnable = __webpack_require__(444);
;// CONCATENATED MODULE: ./src/js/utils/copyToClipboard.js
// return a promise
...
/* harmony default export */ const utils_copyToClipboard = (copyToClipboard);
...
// EXTERNAL MODULE: ./src/js/utils/isTouchEnabled.ts
var isTouchEnabled = __webpack_require__(145);
;// CONCATENATED MODULE: ./src/js/utils/remToPx.js
const remToPx = (rem) => {
	return rem * parseFloat(getComputedStyle(document.documentElement).fontSize);
}

/* harmony default export */ const utils_remToPx = (remToPx);

;// CONCATENATED MODULE: ./src/js/utils/parsePx.js
...
/* harmony default export */ const utils_parsePx = (parsePx);

// EXTERNAL MODULE: ./src/js/components/videoPlayer.ts
var videoPlayer = __webpack_require__(659);
// EXTERNAL MODULE: ./src/js/components/youtubePlayer.ts
var youtubePlayer = __webpack_require__(1134);
// EXTERNAL MODULE: ./src/js/components/dragToScroll.ts
var dragToScroll = __webpack_require__(2177);
var dragToScroll_default = /*#__PURE__*/__webpack_require__.n(dragToScroll);
// EXTERNAL MODULE: ./src/js/components/mediaViewer.ts
var mediaViewer = __webpack_require__(1498);
// EXTERNAL MODULE: ./src/js/components/swiper.ts
var swiper = __webpack_require__(4220);
// EXTERNAL MODULE: ./src/js/components/event.ts
var components_event = __webpack_require__(457);
// EXTERNAL MODULE: ./src/js/components/eventTicket.ts
var eventTicket = __webpack_require__(4713);
// EXTERNAL MODULE: ./src/js/components/buyEventTicketModals.ts
var buyEventTicketModals = __webpack_require__(5156);
// EXTERNAL MODULE: ./src/css/variables.module.scss
var variables_module = __webpack_require__(4908);
...
var addTimer = __webpack_require__(5856);
// EXTERNAL MODULE: ./src/components/@uiKit/LinearSelect/addLinearSelect.ts
var addLinearSelect = __webpack_require__(4819);
// EXTERNAL MODULE: ./src/components/AccumGoal/addAccumGoal.ts
var addAccumGoal = __webpack_require__(1219);
// EXTERNAL MODULE: ./src/components/@uiKit/Select/addSelect.ts
var addSelect = __webpack_require__(2548);
// EXTERNAL MODULE: ./src/components/@uiKit/MultiSelect/addMultiSelect.ts
var addMultiSelect = __webpack_require__(4287);
var addMultiSelect_default = /*#__PURE__*/__webpack_require__.n(addMultiSelect);
// EXTERNAL MODULE: ./src/components/@uiKit/InputUrlSync/addInputUrlSync.ts
var addInputUrlSync = __webpack_require__(2397);
// EXTERNAL MODULE: ./src/components/@uiKit/ToggleButtonGroup/addToggleButtonGroup.ts
var addToggleButtonGroup = __webpack_require__(577);
...
const ANIMATION_SLOW_MS = parseFloat(variables_module["default"]["animation-slow"]) * 1000;
const ANIMATION_NORMAL_MS = parseFloat(variables_module["default"]["animation-normal"]) * 1000;
const POPPER_VIEWPORT_PADDING = utils_parsePx(variables_module["default"]["popper-viewport-padding"]);

external_jQuery_default()(document).ready(function () {

	// popper

	external_jQuery_default()('.popper').each((i, popperMenu) => {
		const onHover = external_jQuery_default()(popperMenu).data('popper-on-hover') !== undefined;
		const anchorElement = external_jQuery_default()(external_jQuery_default()(popperMenu).data('popper-anchor-element'));
		const closeElements = external_jQuery_default()(popperMenu).find('[data-popper-close-element]')
		...
		const openPopper = (currentAnchorElement, _options) => {
			...
			if (!popper) popper = (0,lib_popper/* createPopper */.fi)(currentAnchorElement, popperMenu, {
				strategy: "fixed",
				modifiers: [{
			...
			if (!options.disableOverlay) {
				overlay = external_jQuery_default()("<div>")
					.addClass("popper-overlay")
					.on("click", closePopper)
					.prependTo("body");
			}
			external_jQuery_default()(popperMenu).addClass("open");
		}
		const closePopper = () => {
			external_jQuery_default()(overlay).remove();
			overlay = undefined;
			external_jQuery_default()(popperMenu).removeClass("open");
			clearTimeout(closingTimeout);
		...
		if (onHover) {
			external_jQuery_default()(anchorElement)
				.on("mouseenter", (e) => {
					const isOpen = external_jQuery_default()(popperMenu).hasClass("open");
			...
			external_jQuery_default()(closeElements)
				.on("click", () => {
					closePopper();
				});
			external_jQuery_default()(anchorElement)
	...
	external_jQuery_default()('.input').each((i, input) => {
		const realInput = external_jQuery_default()(input).find("input").get(0);

		external_jQuery_default()(input)
			.click(() => external_jQuery_default()(realInput).focus());

		external_jQuery_default()(realInput)
			.focus(() => external_jQuery_default()(input).addClass("focus"))
			.blur(() => external_jQuery_default()(input).removeClass("focus"));
	});

	external_jQuery_default()('.input-password').each((i, input) => {
		const realInput = external_jQuery_default()(input).find("input").get(0);
		const eyeBtn = external_jQuery_default()(input).find(".input-password__eye-btn").get(0);

		const turnEyeOn = () => {
			external_jQuery_default()(input).addClass("eye-on");
			external_jQuery_default()(input).removeClass("eye-off");
			external_jQuery_default()(realInput).attr("type", "text");
		}

		const turnEyeOff = () => {
			external_jQuery_default()(input).addClass("eye-off");
			external_jQuery_default()(input).removeClass("eye-on");
			external_jQuery_default()(realInput).attr("type", "password");
		}

		external_jQuery_default()(eyeBtn).click((e) => {
			e.stopPropagation();
			if (external_jQuery_default()(input).hasClass("eye-on")) {
				turnEyeOff();
			}
			else {
				turnEyeOn();
	...
	const closeModal = (modal) => {
		external_jQuery_default()(modal).removeClass("open");
		external_jQuery_default()(document.documentElement).removeClass("modal-open");
	};

	const openModal = (modal) => {
		external_jQuery_default()(modal).addClass("open");
		external_jQuery_default()(document.documentElement).addClass("modal-open");
	};

	external_jQuery_default()('.modal').each((i, modal) => {
		external_jQuery_default()(modal).addClass("ready");
		external_jQuery_default()(modal).find(".block__title-action > .modal__close-btn").click(() => closeModal(modal));
	});

	external_jQuery_default()('.modal-trigger').each((i, modalTrigger) => {
		const modal = external_jQuery_default()(external_jQuery_default()(modalTrigger).attr("data-modal-trigger-target"));
		external_jQuery_default()(modalTrigger).click(() => openModal(modal));
	});
	...
	external_jQuery_default()('.copy-text').each((i, copyText) => {
		const value = external_jQuery_default()(copyText).find(".copy-text__value").text().trim();
		const tooltip = external_jQuery_default()(copyText).find(".copy-text__success-tooltip").get(0);
		document.body.appendChild(tooltip);
		...
		const popper = (0,lib_popper/* createPopper */.fi)(copyText, tooltip, {
			placement: placement,
			strategy: "absolute",
			modifiers: [
				{
				...
				(0,popperModifiers.createPlacementHandler)((placement, element) => {
					external_jQuery_default()(element).removeClass("top");
					external_jQuery_default()(element).removeClass("left");
					external_jQuery_default()(element).removeClass("right");
					external_jQuery_default()(element).removeClass("bottom");
					external_jQuery_default()(element).addClass(placement);
				}),
			],
		});
		...
		const showTooltip = () => {
			...
			external_jQuery_default()(tooltip).addClass("show").removeClass("fade-out-slow");
		}
		...
		const hideTooltip = (options = {}) => {
			...
			if (options.rightNow) {
				external_jQuery_default()(tooltip).removeClass("show").removeClass("fade-out-slow");
			}
			else {
				external_jQuery_default()(tooltip).addClass("fade-out-slow");
		...
		external_jQuery_default()(copyText).click(() => {
			utils_copyToClipboard(value).then(() => {
				showTooltip();
		...
		external_jQuery_default()(document).click((e) => {
			if (external_jQuery_default()(copyText).has(e.target).length === 0 && !external_jQuery_default()(e.target).hasClass("copy-text")) {
	...
	external_jQuery_default()(".promo-card").each((i, promoCard) => {
		const more = external_jQuery_default()(promoCard).find(".promo-card__content-more").get(0);
		const expandBtn = external_jQuery_default()(promoCard).find(".promo-card__expand-btn").get(0);
		const collapseBtn = external_jQuery_default()(promoCard).find(".promo-card__collapse-btn").get(0);

		external_jQuery_default()(expandBtn).click(() => {
			external_jQuery_default()(more).addClass("expand");
			external_jQuery_default()(expandBtn).removeClass("active");
			external_jQuery_default()(collapseBtn).addClass("active");

			const animationTime = Math.sqrt(more.scrollHeight) / 20;

			external_jQuery_default()(more).css("height", `${more.scrollHeight}px`);
			external_jQuery_default()(more).css("transition", `height ${animationTime}s`);
		});

		external_jQuery_default()(collapseBtn).click(() => {
			external_jQuery_default()(more).removeClass("expand");
			external_jQuery_default()(collapseBtn).removeClass("active");
			external_jQuery_default()(expandBtn).addClass("active");

			const animationTime = Math.sqrt(more.scrollHeight) / 20;

			external_jQuery_default()(more).css("height", "0px");
			external_jQuery_default()(more).css("transition", `height ${animationTime}s`);
		});
	});
	...
	external_jQuery_default()(".tabs").each((i, tabs) => {
		...
		const popper = (0,lib_popper/* createPopper */.fi)(moreItems, moreItemsMenu, {
			strategy: "fixed",
		})

		const openMoreItemsMenu = () => {
			overlay = external_jQuery_default()("<div class='tabs__overlay'></div>")
				.click((e) => {
					external_jQuery_default()(e.currentTarget).remove();
					external_jQuery_default()(moreItemsMenu).removeClass("open");
				})
				.prependTo("body");
			external_jQuery_default()(moreItemsMenu).addClass("open");
			popper.update();
		};
		...
		const toggleMoreItemsMenu = () => {
			if (external_jQuery_default()(moreItemsMenu).hasClass("open")) {
				closeMoreItemsMenu();
			}
			else {
				openMoreItemsMenu();
	...
	const updateHeight = (element) => {
		...
		if (maxHeight && element.scrollHeight < maxHeight) {
			external_jQuery_default()(element).css({
	...
	external_jQuery_default()(".textarea-autosize").each((i, textareaAutosize) => {

		// add handlers
		external_jQuery_default()(textareaAutosize).on("input", (e) => {
	...
	external_jQuery_default()(".with-tooltip").each((i, trigger) => {
		const placement = trigger.dataset.withTooltipPlacement || "top";
		const tooltip = trigger.querySelector(".tooltip");

		const popper = (0,lib_popper/* createPopper */.fi)(trigger, tooltip, {
			placement: placement,
			strategy: "absolute",
			modifiers: [
				{
		...
		trigger.addEventListener("mouseenter", () => {
			...
			external_jQuery_default()(tooltip).addClass("show").removeClass("fade-out");
			clearTimeout(disappearTimeoutId);
			(0,popperEnable.enablePopper)(popper);
			popper.update();
		});

		trigger.addEventListener("mouseleave", () => {
			external_jQuery_default()(tooltip).addClass("fade-out");

			disappearTimeoutId = setTimeout(() => {
				external_jQuery_default()(tooltip).removeClass("show");
				(0,popperEnable.disablePopper)(popper);
			}, ANIMATION_SLOW_MS)
		});
	})
	...
	external_jQuery_default()(".programs").each((i, programs) => {
		const expandBtn = external_jQuery_default()(programs).find(".programs__expand-btn button").get(0);
		const collapseBtn = external_jQuery_default()(programs).find(".programs__collapse-btn button").get(0);

		external_jQuery_default()(expandBtn).click(() => {
			external_jQuery_default()(programs).addClass("expand");
		});

		external_jQuery_default()(collapseBtn).click(() => {
			external_jQuery_default()(programs).removeClass("expand");
		});
	});
	...
	const openMenu = () => {
		...
		external_jQuery_default()("#sideMenu").addClass("open").find(".side-menu__body").scrollTop(0);
		external_jQuery_default()("#header .header__burger-btn").addClass("open");
		external_jQuery_default()(document.documentElement).addClass("modal-open");
	}
	const closeMenu = () => {
		external_jQuery_default()("#sideMenu").removeClass("open").addClass("hiding");
		external_jQuery_default()("#header .header__burger-btn").removeClass("open");
		clearTimeout(hidingTimeoutId);
		hidingTimeoutId = setTimeout(() => {
			external_jQuery_default()("#sideMenu").removeClass("hiding");
		}, ANIMATION_NORMAL_MS);
		external_jQuery_default()(document.documentElement).removeClass("modal-open");
	}
	const toggleMenu = () => {
		if (external_jQuery_default()("#sideMenu").hasClass("open")) {
			closeMenu();
		}
		else {
			openMenu();
	...
	external_jQuery_default()('#sideMenu .side-menu__overlay').click(closeMenu);
	external_jQuery_default()("#sideMenu .tab").click(closeMenu);
	external_jQuery_default()("#header .header__burger-btn").click(toggleMenu);

	// header

	const headerTitle = external_jQuery_default()("#header .header__title").get(0);

	if (headerTitle) {
		new ResizeObserver(() => {
			if (headerTitle.scrollWidth > headerTitle.clientWidth) {
				external_jQuery_default()(headerTitle).addClass("overflow")
			}
			else {
				external_jQuery_default()(headerTitle).removeClass("overflow")
			}
		}).observe(headerTitle)
	}
	...
	external_jQuery_default()(".collapse-table").each((i, collapseTable) => {
		const collapseBtn = external_jQuery_default()(collapseTable).find(".collapse-table__collapse-btn button").get(0);
		const expandBtn = external_jQuery_default()(collapseTable).find(".collapse-table__expand-btn button").get(0);

		external_jQuery_default()(expandBtn).click(() => {
			external_jQuery_default()(collapseTable).addClass("expand");
		})

		external_jQuery_default()(collapseBtn).click(() => {
			external_jQuery_default()(collapseTable).removeClass("expand");
		})
	})

	// line list

	external_jQuery_default()(".line-list").each((i, lineList) => {
		const menu = external_jQuery_default()(lineList).find(".line-list__menu");
		const trigger = external_jQuery_default()(lineList).find(".line-list__trigger");

		external_jQuery_default()(trigger).click(() => {
			external_jQuery_default()(lineList).toggleClass("open");
		});

		external_jQuery_default()(menu).click(() => {
			external_jQuery_default()(lineList).removeClass("open");
		});

		external_jQuery_default()(document).click((e) => {
			if (external_jQuery_default()(lineList).has(e.target).length === 0) {
				external_jQuery_default()(lineList).removeClass("open");
			}
		})
	})
	...
	external_jQuery_default()(".chat-list").click((e) => {
		if (external_jQuery_default()(e.target).closest(".chat-list__item-pin").length === 0) {
			const chat = external_jQuery_default()(".chat");

			external_jQuery_default()(chat).toggleClass("open");

			if (external_jQuery_default()(chat).hasClass("open")) {
				external_jQuery_default()(document.documentElement).addClass("modal-open");
			}
			else {
				external_jQuery_default()(document.documentElement).removeClass("modal-open");
	...
	external_jQuery_default()(".chat__close-btn").click(() => {
		external_jQuery_default()(".chat").toggleClass("open");
	})

	// cashout pool

	const expressToggler = external_jQuery_default()("#expressToggler");

	external_jQuery_default()(expressToggler).find(".toggle-button").click((e) => {
		const tooltipOn = external_jQuery_default()(expressToggler).find(".express-toggler__on-tooltip");
		const tooltipOff = external_jQuery_default()(expressToggler).find(".express-toggler__off-tooltip");

		if (e.currentTarget.getAttribute("data-value") === "express") {
			external_jQuery_default()(tooltipOn).addClass("active");
			external_jQuery_default()(tooltipOff).removeClass("active");
		}
		else {
			external_jQuery_default()(tooltipOff).addClass("active");
			external_jQuery_default()(tooltipOn).removeClass("active");
		}
	})

	external_jQuery_default()("#cashoutPoolBtn").click(() => {
		if (external_jQuery_default()(expressToggler).find(".toggle-button.active")[0].getAttribute("data-value") === "express") {
			external_jQuery_default()("#cashoutPoolExpressAlert").addClass("show");
			external_jQuery_default()("#cashoutPoolAlert").removeClass("show");
		}
		else {
			external_jQuery_default()("#cashoutPoolAlert").addClass("show");
			external_jQuery_default()("#cashoutPoolExpressAlert").removeClass("show");
		}
	})

	// form

	external_jQuery_default()("form").submit((e) => {
		e.preventDefault();
	})
	...
	window.addEventListener('load', () => {
		...
		if ((0,isTouchEnabled["default"])()) return;
	...
	// video player
	;(0,videoPlayer/* default */.Z)();

	// drag to scroll
	if (!(0,isTouchEnabled["default"])()) {
		dragToScroll_default()();
	}

	// media viewer
	(0,mediaViewer/* default */.Z)();

	// swiper
	(0,swiper/* default */.Z)();

	// event 
	(0,components_event/* default */.Z)();

	// event-ticket
	(0,eventTicket/* default */.Z)();

	// buy event tickets
	(0,buyEventTicketModals/* default */.Z)();

	// youtube
	(0,youtubePlayer/* default */.Z)();
});
...
window.addEventListener("load", () => {
	...
	(0,addAccumGoal/* default */.Z)();
	(0,addSelect/* default */.Z)();
	addMultiSelect_default()();
	(0,addInputUrlSync/* default */.Z)();
	(0,addToggleButtonGroup/* default */.Z)();
})
;// CONCATENATED MODULE: ./src/js/_export/common.js
